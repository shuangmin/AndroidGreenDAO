...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        MqttChatEntityDao.createTable(db, ifNotExists);
        SessionEntityDao.createTable(db, ifNotExists);
        ReplayEntityDao.createTable(db, ifNotExists);
    ...
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        MqttChatEntityDao.dropTable(db, ifExists);
        SessionEntityDao.dropTable(db, ifExists);
        ReplayEntityDao.dropTable(db, ifExists);
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(MqttChatEntityDao.class);
        registerDaoClass(SessionEntityDao.class);
        registerDaoClass(ReplayEntityDao.class);
